...
var ASM_CONSTS = {
  14596: function() {FS.syncfs(function (err) {});},  
 14626: function() {FS.mkdir('/data'); FS.mount(IDBFS, {}, '/data'); FS.syncfs(true, function (err) { assert(!err); ccall('test', 'v'); }); console.log('hello world');}
};
